...
__CONST__(LIFE_SCHEMA_NAME,"'liferpg'");//CHANGE THIS IF YOUR DATABASE IS NOT CALLED ARMA3LIFE KEEP THE ' '
publicVariable "LIFE_SCHEMA_NAME";

[] execVM "\life_server\fn_initHC.sqf";

life_radio_west = radioChannelCreate [[0, 0.95, 1, 0.8], "Cop Channel", "[COP]  %UNIT_NAME", []];
life_radio_civ = radioChannelCreate [[0, 0.95, 1, 0.8], "Civ Channel", "[CIV] %UNIT_NAME", []];
life_radio_indep = radioChannelCreate [[0, 0.95, 1, 0.8], "Medic Channel", "[MEDIC] %UNIT_NAME", []];
